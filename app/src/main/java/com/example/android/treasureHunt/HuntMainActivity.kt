...
class HuntMainActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        // Step 7: check that the user turned on their device location and ask
    ...
    override fun onRequestPermissionsResult(
        ...
        // Step 5: handle the result of the user's permission
    ...
    private fun checkDeviceLocationSettingsAndStartGeofence(resolve:Boolean = true) {
        // Step 6: check that the device's location is on
    ...
    private fun foregroundAndBackgroundLocationPermissionApproved(): Boolean {
        // Step 3 check that the foreground and background permissions were approved
        val isForegroundPermissionApproved = (
        ...
        return isForegroundPermissionApproved && isBackgroundPermissionApproved
    }
